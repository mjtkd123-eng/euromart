...
const dict = {
  ...
  helpMenu: { ko: "고객 센터 메뉴", en: "Help Center menu" },
  helpHubTitle: { ko: "무엇을 도와드릴까요?", en: "How can we help?" },
  helpHubDesc: {
    ko: "배송, 결제, 환불, 개인정보까지 — K-EuroMart 이용에 필요한 모든 안내를 한곳에 모았습니다.",
    en: "Shipping, payments, refunds, and privacy — everything you need to use K-EuroMart, in one place.",
  },
  helpSearchLabel: { ko: "도움말 검색", en: "Search help" },
  helpSearchPlaceholder: {
    ko: "무엇을 도와드릴까요? 예: 배송 기간, 환불, 결제 오류",
    en: "How can we help? e.g. delivery time, refund, payment error",
  },
  helpSearchButton: { ko: "검색", en: "Search" },
  helpNoAnswerTitle: { ko: "원하는 답을 찾지 못하셨나요?", en: "Still need help?" },
  helpNoAnswerDesc: {
    ko: "1:1 문의를 남기거나 실시간 챗봇 상담을 이용하세요.",
    en: "Send a 1:1 inquiry or chat with our support bot.",
  },
  contactUs: { ko: "1:1 문의하기", en: "Contact us" },
  faqSearchLabel: { ko: "질문 검색", en: "Search questions" },
  faqSearchPlaceholder: {
    ko: "궁금한 내용을 검색하세요 — 예: 무료배송, 3D Secure, 신선식품 환불",
    en: "Search for an answer — e.g. free delivery, 3D Secure, fresh food refund",
  },
  filterAll: { ko: "전체", en: "All" },
  faqNoResults: {
    ko: "'{query}'에 대한 결과를 찾지 못했습니다. 다른 키워드로 검색하거나 1:1 문의를 이용해 주세요.",
    en: "No results for '{query}'. Try another keyword or send a 1:1 inquiry.",
  },
  faqDraftAnswer: {
    ko: "해당 문의는 매장·정책에 따라 다를 수 있어 확인 후 정확히 안내드립니다. 급하시면 주문번호와 함께 고객센터({email})로 문의해 주세요.",
    en: "This depends on the store and current policy — we’ll confirm and get back to you. For urgent cases, contact support ({email}) with your order number.",
  },
  learnMore: { ko: "자세히 보기 →", en: "Learn more →" },
  loading: { ko: "불러오는 중…", en: "Loading…" },
  shippingFreeTitle: { ko: "무료배송 기준", en: "Free delivery threshold" },
  shippingFreeBody: {
    ko: "일정 금액 이상 주문 시 배송비가 무료입니다. 기준 금액은 매장의 현지 통화 기준이며 국가·매장별로 다릅니다. 예: 헝가리 15,000 Ft 이상 무료배송.",
    en: "Orders over a set amount ship free. Thresholds use the store’s local currency and vary by country and store. Example: Hungary — free over 15,000 Ft.",
  },
  shippingPartner: { ko: "배송 파트너", en: "Delivery partner" },
  shippingLocalDelivery: { ko: "도시 내 배달", en: "In-city delivery" },
  shippingRegional: { ko: "지역 외 배송", en: "Regional delivery" },
  shippingFree: { ko: "무료배송", en: "Free delivery" },
  shippingBaseFee: { ko: "기본 배송비", en: "Standard fee" },
  shippingFreshTitle: { ko: "신선·냉장·냉동식품 배송", en: "Fresh, chilled & frozen delivery" },
  shippingFreshBody: {
    ko: "콜드체인 유지를 위해 신선식품은 도시 내 당일 배달을 우선 제공합니다. 폭염 등 품질에 영향을 줄 수 있는 상황에서는 배송 일정이 조정될 수 있습니다.",
    en: "To keep the cold chain, fresh food is prioritized for same-day in-city delivery. Schedules may change in heatwaves or other conditions that affect quality.",
  },
  shippingNotesTitle: { ko: "배송 유의사항", en: "Delivery notes" },
  returnsBanner: {
    ko: "K-EuroMart는 EU 소비자권리지침(2011/83/EU)을 준수합니다. 아래 안내는 이용자의 법정 권리를 보완하는 것으로, 소비자의 법적 권리를 제한하지 않습니다.",
    en: "K-EuroMart complies with the EU Consumer Rights Directive (2011/83/EU). The information below complements your statutory rights and does not limit them.",
  },
  returnsCtaTitle: { ko: "환불·교환을 신청하시겠어요?", en: "Want to request a refund or exchange?" },
  returnsCtaDesc: {
    ko: "주문번호와 상품 사진(파손·변질 시)을 준비해 1:1 문의로 접수하면 빠르게 도와드립니다.",
    en: "Have your order number ready — and photos if an item arrived damaged or spoiled — and send a 1:1 inquiry.",
  },
  returnsCtaButton: { ko: "환불·교환 문의", en: "Refund / exchange inquiry" },
  legalTablist: { ko: "법적 고지 문서", en: "Legal documents" },
  legalDraftNote: {
    ko: "본 문서는 초안이며, 실제 서비스 운영 정책과 관련 법령에 따라 확정·개정됩니다. 법적 효력이 필요한 최종본은 운영 정책 확정 후 게시됩니다.",
    en: "This document is a draft and will be finalized under our operating policy and applicable law. The legally binding version will be published once policy is confirmed.",
  },
  noticePinned: { ko: "고정", en: "Pinned" },
  noticeEmpty: { ko: "해당 분류의 공지가 없습니다.", en: "No notices in this category." },
  contactFormTitle: { ko: "1:1 문의 남기기", en: "Send a 1:1 inquiry" },
  contactFormDesc: {
    ko: "문의 유형과 내용을 남겨 주시면 순차적으로 답변드립니다.",
    en: "Choose a topic and tell us what you need — we’ll reply in order.",
  },
  inquiryTopic: { ko: "문의 유형", en: "Topic" },
  optional: { ko: "(선택)", en: "(optional)" },
  messageLabel: { ko: "문의 내용", en: "Message" },
  submitInquiry: { ko: "문의 접수", en: "Submit inquiry" },
  newInquiry: { ko: "새 문의 작성", en: "Write another inquiry" },
  inquiryReceived: { ko: "문의가 접수되었습니다", en: "Your inquiry has been received" },
  inquiryReceivedDesc: {
    ko: "입력하신 이메일({email})로 답변드리겠습니다. 확인을 위해 주문번호를 함께 남겨 주시면 처리가 빨라집니다.",
    en: "We’ll reply to {email}. Including your order number helps us resolve this faster.",
  },
  contactPrivacyNote: {
    ko: "제출하신 정보는 문의 응대 목적으로만 사용되며, 개인정보 처리방침에 따라 처리됩니다.",
    en: "We use the information you submit only to handle your inquiry, in line with our privacy policy.",
  },
  chatbotTitle: { ko: "실시간 챗봇 상담", en: "Live chatbot help" },
  chatbotDesc: {
    ko: "배송·결제·환불 등 자주 묻는 질문은 챗봇이 즉시 안내합니다. 해결이 어려우면 상담원 연결로 이어집니다.",
    en: "The chatbot can answer common shipping, payment, and refund questions right away. If that’s not enough, we’ll connect you to a person.",
  },
  viewFaq: { ko: "자주 묻는 질문 보기", en: "Browse FAQs" },
  supportInfo: { ko: "고객센터 안내", en: "Support details" },
  email: { ko: "이메일", en: "Email" },
  supportHours: { ko: "상담 시간", en: "Hours" },
  supportLanguages: { ko: "지원 언어", en: "Languages" },
  emailPlaceholder: { ko: "답변 받을 이메일", en: "Email for our reply" },
  messagePlaceholder: {
    ko: "문의하실 내용을 자세히 적어 주세요. 파손·변질 상품은 사진을 준비해 주시면 처리가 빨라집니다.",
    en: "Please describe your issue. Photos of damaged or spoiled items help us resolve this faster.",
  },
  orderPlaceholder: { ko: "예: KEM-20260825-0001", en: "e.g. KEM-20260825-0001" },
  paymentHelpBadge: { ko: "고객센터 · 결제 도움말", en: "Help Center · Payments" },
  paymentHelpH1: { ko: "결제 오류, 여기서 해결하세요", en: "Payment issues, solved here" },
  paymentHelpIntro: {
    ko: "결제 거절, 이중 청구, 통화·환불 등 자주 발생하는 결제 문제의 원인과 해결 방법을 정리했습니다.",
    en: "Causes and fixes for common payment problems — declines, double charges, currency, and refunds.",
  },
  paymentHelpSearch: {
    ko: "무엇을 도와드릴까요? (예: 결제 거절, 환불)",
    en: "How can we help? (e.g. declined payment, refund)",
  },
  paymentHelpSearchLabel: { ko: "결제 도움말 검색", en: "Search payment help" },
  paymentCause: { ko: "원인", en: "Cause" },
  paymentSteps: { ko: "해결 방법", en: "How to fix it" },
  paymentTip: { ko: "도움말", en: "Tip" },
  paymentNoResults: { ko: "검색 결과가 없습니다", en: "No results" },
  paymentNoResultsHint: {
    ko: "다른 검색어를 입력하거나 아래 고객센터로 문의해 주세요.",
    en: "Try another search term, or contact support below.",
  },
  paymentStillStuck: { ko: "문제가 계속되나요?", en: "Still stuck?" },
  paymentStillStuckDesc: {
    ko: "위 방법으로 해결되지 않으면 주문번호와 함께 고객센터로 문의해 주세요. 결제 관련 문의는 우선 처리됩니다.",
    en: "If this didn’t help, contact support with your order number. Payment issues are handled first.",
  },
  emailInquiry: { ko: "이메일 문의", en: "Email us" },
  supportHoursLabel: { ko: "응대 시간", en: "Hours" },
  paymentHoursValue: {
    ko: "평일 09:00–18:00 (CET) · 24시간 내 회신",
    en: "Weekdays 09:00–18:00 (CET) · reply within 24 hours",
  },
  paymentEuNote: {
    ko: "K-EuroMart는 EU 소비자 보호 규정을 준수합니다 · k-euromart.com",
    en: "K-EuroMart complies with EU consumer protection rules · k-euromart.com",
  },
  paymentCatDeclined: { ko: "결제 거절", en: "Declined" },
  paymentCatCharge: { ko: "청구 오류", en: "Charges" },
  paymentCatPending: { ko: "결제 확인", en: "Pending" },
  paymentCatPromo: { ko: "프로모션", en: "Promo" },
  paymentCatCurrency: { ko: "통화·환율", en: "Currency" },
  paymentCatRefund: { ko: "환불", en: "Refund" },
  paymentMailSubject: { ko: "결제 문의", en: "Payment inquiry" },
  backToStore: { ko: "스토어로 돌아가기", en: "Back to store" },
  homeAria: { ko: "K-EuroMart 홈으로", en: "K-EuroMart home" },
  faqPageDesc: {
    ko: "키워드로 검색하거나 카테고리를 골라 가장 많이 찾는 질문의 답을 확인하세요.",
    en: "Search by keyword or pick a category to find answers to the most common questions.",
  },
  shippingPageDesc: {
    ko: "국가별 배송 기간과 배송 파트너, 무료배송 기준을 확인하세요. 신선식품은 콜드체인으로 당일 배달을 우선합니다.",
    en: "Check delivery times, partners, and free-shipping thresholds by country. Fresh food is prioritized for same-day cold-chain delivery.",
  },
  paymentPageDesc: {
    ko: "지원 결제 수단, 결제 오류 대처법, 인보이스(영수증) 발급.",
    en: "Supported payment methods, what to do if checkout fails, and how to request an invoice.",
  },
  returnsPageDesc: {
  ...
  noticePageDesc: {
    ko: "이벤트, 배송 지연, 휴무일 등 K-EuroMart의 최신 소식을 안내합니다.",
    en: "Events, delivery delays, holidays, and other K-EuroMart updates.",
  },
  contactPageDesc: {
    ko: "1:1 문의를 남기거나 실시간 챗봇 상담을 이용하세요. 주문번호를 함께 남기면 더 빠르게 도와드립니다.",
