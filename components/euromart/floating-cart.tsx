...
export function FloatingCart() {
  const { region, itemCount, subtotal, setCartOpen, cartOpen, t } = useEuromart()
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-4 z-30 flex justify-center px-4">
      <button
        ...
        aria-label={`${t("openCart")} — ${t("productCount", { count: itemCount })}, ${t(
          "totalLabel",
        )} ${formatPrice(subtotal, region.currency)}`}
      >
