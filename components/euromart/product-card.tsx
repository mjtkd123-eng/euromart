  ...
  return (
    <article className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-card transition-shadow hover:shadow-md">
      <div className="relative aspect-square overflow-hidden bg-muted">
        ...
        {product.outOfStock && (
          <div className="absolute inset-0 flex items-center justify-center bg-background/70">
            <span className="rounded-full bg-foreground px-3 py-1 text-xs font-bold text-background">품절</span>
          </div>
        )}
      </div>
      ...
      <div className="flex flex-1 flex-col gap-1 p-3">
        ...
        <h3 className="text-pretty text-sm font-bold leading-snug text-foreground">{product.nameKo}</h3>
