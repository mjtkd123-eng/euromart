...
export function CategoryFilter() {
  const { products, activeCategory, setActiveCategory, t } = useEuromart()
  ...
  return (
    <nav aria-label={t("categoryFilter")} className="mx-auto max-w-6xl px-4 pt-6">
        ...
        {available.map((cat) => {
          ...
          return (
            ...
            >
              ...
              <span>{t(`cat.${cat.id}` as TransKey)}</span>
            </button>
          )
        })}
      </div>
